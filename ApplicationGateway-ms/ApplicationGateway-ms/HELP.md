...
* The original package name 'com.application.springcloud.APIGateway.ApplicationGateway-ms' is invalid and this project uses 'com.application.springcloud.APIGateway.ApplicationGatewayms' instead.
